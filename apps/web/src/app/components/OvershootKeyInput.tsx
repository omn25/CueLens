...
interface OvershootKeyInputProps {
  onSave: (key: string) => void;
  initialKey?: string;
}

export default function OvershootKeyInput({ onSave, initialKey = '' }: OvershootKeyInputProps) {
  ...
  const handleSave = () => {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('OVERSHOOT_API_KEY', apiKey.trim());
    }
